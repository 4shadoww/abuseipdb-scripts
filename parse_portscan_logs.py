...
def main(arguments):
    ...
    for line in args.infile:
        ...
        if matches:
            ...
            attack_datetime = datetime.strptime(matches_flat[0], '%Y-%m-%d %H:%M:%S')
            ...
            if matches_flat[1] not in ipv4_addresses:
                ipv4_addresses.append(matches_flat[1])
            else:
                continue
